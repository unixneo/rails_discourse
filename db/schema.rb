...
ActiveRecord::Schema.define() do
  ...
  create_table "categories", id: :serial, force: :cascade do |t|
    ...
    t.index "COALESCE(parent_category_id, '-1'::integer), slug", name: "unique_index_categories_on_slug", unique: true, where: "((slug)::text <> ''::text)"
  ...
  create_table "like_data", id: false, force: :cascade do |t|
    t.integer "user_id"
    t.integer "post_id"
    t.datetime "created_at"
  end
  ...
  create_table "post_search_data", primary_key: "post_id", id: :integer, default: nil, force: :cascade do |t|
    ...
    t.index ["search_data"], name: "idx_recent_regular_post_search_data", where: "((NOT private_message) AND (post_id >= 0))", using: :gin
  ...
  create_table "sitemaps", force: :cascade do |t|
    ...
    t.boolean "enabled", default: true, null: false
    t.index ["name"], name: "index_sitemaps_on_name", unique: true
  end
  ...
  create_table "topic_custom_fields", id: :serial, force: :cascade do |t|
    ...
    t.index ["topic_id"], name: "idx_topic_custom_fields_accepted_answer", unique: true, where: "((name)::text = 'accepted_answer_post_id'::text)"
  ...
  create_table "unsubscribe_keys", primary_key: "key", id: :string, limit: 64, force: :cascade do |t|
    t.integer "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
